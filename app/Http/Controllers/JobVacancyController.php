...
class JobVacancyController extends Controller
{
    ...
    public function processApplication(ApplyJobRequest $request, string $id)
    {
        ...
        if ($request->input('resume_option') === 'new_resume') {
            ...
            // only setting the values of the existing resume
            $extractedInfo = [
        ...
        return redirect()->route('job-applications.index', ['id' => $id])->with('success', 'Application submitted successfully and is under review.');
