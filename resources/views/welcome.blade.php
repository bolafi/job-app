<x-main-layout title="Shaghalni - Find your dream job">
    <div x-data="{show:false}" x-init="setTimeout(() => show = true, 300)">
        <div class="inline-flex items-center" x-cloak x-show="show"
    ...
    <div x-data="{show:false}" x-init="setTimeout(() => show = true, 300)">
        <div x-cloak x-show="show" x-transition:enter="transition ease-out duration-700"
            ...
            <h1 class="text-4xl sm:6xl md:text-8xl font-bold mb-6 tracking-tight">
    ...
    <div x-data="{show:false}" x-init="setTimeout(() => show = true, 300)">
        <div x-cloak x-show="show" x-transition:enter="transition ease-out duration-700"
            ...
            <a href="{{ route('login') }}"
                class="rounded-lg bg-gradient-to-r from-indigo-500 to-rose-500 px-4 py-2 text-white">Login</a>
        </div>
    </div>
</x-main-layout>