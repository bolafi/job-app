        ...
        <div class="bg-black shadow-lg rounded-lg p-6 max-w-7xl mx-auto">
            ...
            <div class="border-b border-white/10 pb-6">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{ route('job-vacancies.apply', $jobVacancy->id) }}" class="w-full justify-center bg-gradient-to-r from-indigo-500 to-rose-500 
                    text-white rounded-lg px-4 py-2 transition hover:from-indigo-600 hover:to-rose-600">Apply Now</a>
                    </div>
                </div>
            </div>
            <!-- Job Description -->
            <div class="grid grid-cols-3 gap-4 mt-6">
                ...
                <div class="col-span-1">
                    <h2 class="text-2xl font-bold text-white">Job Overview</h2>
